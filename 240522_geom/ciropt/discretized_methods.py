...
def dadmm(alg_type, problem_spec, problem_data, network_data, x_opt_star, f_star, 
    ...
    if alg_type == "dadmm": 
        ...
        step_size = h / Inductance
    elif alg_type == "cir_dadmm_c2":
        R, h, Inductance, Inductance_S, Capacitance = params["R"], params["h"], params["Inductance"], params["Inductance_S"], params["Capacitance"]
        step_size = h / Inductance
        step_size_S = h / Inductance_S
