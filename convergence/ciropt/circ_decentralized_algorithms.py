...
def dadmm_C_all_graph6(mu, L_smooth, R, Capacitance, Inductance, params=None):
    ...
    E_2 = Inductance * (i_L_12_2 - y1_12_star) ** 2 + Inductance * (i_L_13_2 - y1_13_star) ** 2 \
            ...
            + (Capacitance / 2) * (e_46_2 - x_star) ** 2
    # currents on resistors on each net sum to 0
    # Delta_2 = d * ( (1/R) * ((e_12_2 - x1_2)**2 + (e_12_2 - x2_2)**2)   \
    #                 + (1/R) * ((e_13_2 - x1_2)**2 + (e_13_2 - x3_2)**2) \
    #                 + (1/R) * ((e_23_2 - x2_2)**2 + (e_23_2 - x3_2)**2) \
    #                 + (1/R) * ((e_24_2 - x2_2)**2 + (e_24_2 - x4_2)**2) \
