...
def graph_generation(n_node):
    ...
    # (26, 27), (27, 28), (28, 29), (29, 30), (1, 4), (1, 6), (2, 7), (3, 9), \
    # (5, 10), (6, 12), (8, 14), (10, 16), (12, 18), (15, 20), (17, 22), (19, 24), \
    # (21, 26), (23, 28), (25, 30), (2, 15), (4, 20), (6, 25), (8, 30), (10, 12), \
...
def pg_extra_compressed_sensing(method_ver, problem_spec, problem_data, network_data, x_opt_star, f_star, params=None) :
    n_sensor = problem_spec['n_sensor']
    n_sensor_per_node = problem_spec['n_sensor_per_node']
    n_node = problem_spec['n_node']
    vector_size = problem_spec['vector_size']
